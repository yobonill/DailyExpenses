...
export function SettingsView({ data, expenses, syncPendingCount, syncDiagnostics, onRetrySync, onUpdateSettings, onRecordBackup, canInstall, onInstall, onLogout }: {
  data: FinancialData;
  expenses: Expense[];
