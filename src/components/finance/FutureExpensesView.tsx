...
import { CheckboxField, CurrencyField, EmptyPanel, Modal, MoneyField, PageHeading, PayModal, StatusChip, type PayModalValue } from "./Shared";
...
export function FutureExpensesView({ data, onSave, onPay, onReopen, onAllocate }: {
  data: FinancialData;
  ...
  const [form, setForm] = useState<NonMonthlyExpense | "new" | null>(null); const [paying, setPaying] = useState<NonMonthlyOccurrence | null>(null); const [allocating, setAllocating] = useState<NonMonthlyOccurrence | null>(null); const [showCompleted, setShowCompleted] = useState(false);
