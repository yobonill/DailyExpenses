...
function AuthenticatedApp({ user, onLogout }: { user: AppUserDefinition; onLogout: () => Promise<void> }) {
  ...
  const renderView = () => {
    switch (view) {
      ...
      case "cards": return <CreditCardsView data={financial.data} onSaveCard={actions.saveCreditCard} onAddTransaction={actions.addCardTransaction} onReverseTransaction={actions.reverseCardTransaction} />;
