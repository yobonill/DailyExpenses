...
describe("backup validation", () => {
  it("round-trips a versioned complete backup", () => {
    ...
    expect(preview.counts).toMatchObject({ gastosDiarios: 0, gastosMensuales: 0, metasDeCompra: 0, tarjetas: 0, pagosDeTarjetaPlanificados: 0, bancos: 0, cuentasDeDinero: 0, movimientosDeDinero: 0, prestamos: 0, movimientosDePrestamos: 0 });
  });
